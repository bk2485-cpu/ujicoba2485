...
<body>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="#daftar">Daftar Profil</a></li>
    ...
    <main>
        ...
        <section id="about">
            <?php
            session_start();
            $NIM = $_SESSION['nim'] ?? "2511500081";
            $Nama_Lengkap = $_SESSION['nama'] ?? "Arief Budikurniawan &#128526;";
            $Tempat_Lahir = $_SESSION['tempat_lahir'] ?? "Tangerang";
            $Tanggal_Lahir = $_SESSION['tanggal_lahir'] ?? "24 Agustus 2005";
            $Hobi = $_SESSION['hobi'] ?? "Mancing, Billiard &#127921; , Mobile Legend &#127918;";
            $Pasangan = $_SESSION['pasangan'] ?? "Gatau ada dimana";
            $Pekerjaan = $_SESSION['pekerjaan'] ?? "Mahasiswa &copy; 2025";
            $Nama_Orang_Tua = $_SESSION['ortu'] ?? "Bapak Budi Karyanto dan Ibu Dahlia";
            $Nama_Kakak = $_SESSION['kakak'] ?? "Ananda Rizky Faudillah";
            $Nama_Adik = $_SESSION['adik'] ?? "Annisa Tri Muthiazzahra";
            ?>
            <h2>Tentang Saya</h2>
